            ...
            >
              ...
              <div className="mt-6 flex gap-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-xl bg-slate-700 hover:bg-slate-600 transition-colors px-4 py-2 text-sm font-medium text-white"
                >
                  👁️ View
                </a>
                ...
                <a
                  href={doc.file}
                  download
                  className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 transition-colors px-4 py-2 text-sm font-medium text-white"
                >
                  <FaDownload size={16} />
                  Download
                </a>
